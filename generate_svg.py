...
with dot.subgraph(name='cluster_vision_proj') as c:
    ...
    c.node('Vis_Linear', 'Linear\n1024 -> 768', fillcolor='#ffcc80') # Correction: Vision dim 1024 -> Proj 768 (Assuming config)
    c.node('Vis_LN', 'LayerNorm', fillcolor='#ffcc80')
    c.node('Vis_GELU', 'GELU', fillcolor='#ffcc80')
    # Internal edges
...
with dot.subgraph(name='cluster_text_proj') as c:
    ...
    c.node('Txt_Linear', 'Linear\n1024 -> 768', fillcolor='#ffcc80')
    c.node('Txt_LN', 'LayerNorm', fillcolor='#ffcc80')
    c.node('Txt_GELU', 'GELU', fillcolor='#ffcc80')
    # Internal edges
